...
<head>
    ...
    <title>Validador - Conoceles</title>
        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header text-center">
                                            <big><big>Editar Validador</big></big>
                                        ...
                                        <div class="card-body">
                                            <form action="validadores.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    //echo $id_user_edit;
                                                    $query="SELECT * FROM `c_validadores` WHERE `id_user` = ".$id_user_edit."";
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <select id="pp_e" name="pp_e" class="form-select"
                                                            ...
                                                            <?php 
                                                            $query="SELECT * FROM `cat_pp` WHERE `id` = '$id_area_edit'";
                                                            ...
                                                            ?>
                                                            <?php 
                                                                $query="SELECT * FROM `cat_pp` WHERE `status` = '1'";
                    ...
                    ?>
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Validador /</span>
                            Nuevo Validador</h4>
                        <div class="row">
                            <div class="col-lg-1"></div>
                            <div class="col-lg-10">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header text-center">
                                            <big><big>Agregar Nuevo Validador</big></big>
                                            <hr style="border-top:1px dotted" />
                                        </div>
                                        <div class="card-body">
                                            <form action="validadores.php" method="POST">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <label for="exampleFormControlInput1"
                                                            class="form-label">Usuario <strong>(VALID_NOMBR_APEL1_APEL2)</strong></label>
