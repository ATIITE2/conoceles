...
if(isset($_REQUEST['guardar'])){
    ...
    $query="INSERT INTO `cat_puestos_ite` (`nombre`,`status`) 
    VALUES ('".$nombre."','1');";
...
if(isset($_REQUEST['actualizar'])){
    $nombre=$_REQUEST['nombre'];
    $query="UPDATE `cat_puestos_ite`SET `nombre`='".$nombre."' WHERE `id` = '".$_REQUEST['id_cargo']."';";
    mysqli_query($con,$query); 
    //echo $query;
}
if(isset($_REQUEST['edo1'])){
    $qry=" UPDATE `cat_puestos_ite` SET `status`=2 WHERE `id` = '".$_REQUEST['edo1']."';";
    mysqli_query($con,$qry); 
    //echo "<br> $qry";
}
if(isset($_REQUEST['edo2'])){
    $qry=" UPDATE `cat_puestos_ite` SET `status`=1 WHERE `id` = '".$_REQUEST['edo2']."';";
    mysqli_query($con,$qry);
    //echo "<br> $qry"; 
}
if(isset($_REQUEST['edo3'])){
    $qry=" UPDATE `cat_puestos_ite` SET `status`=3 WHERE `id` = '".$_REQUEST['edo3']."';";
    mysqli_query($con,$qry);
    //echo "<br> $qry"; 
}
?>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        ...
                        <div class="row">
                            ...
                            ?>
                            <div class="alert alert-success alert-dismissible" role="alert">
                                Actualización de cargo realizado con Exito!
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            <?php } if(isset($_REQUEST['edo3'])){?>
                            <div class="alert alert-danger alert-dismissible" role="alert">
                                Eliminación de cargo realizado con Exito!
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                            <?php } ?>
                            ...
                            <div class="col-lg-10 mb-6 order-0">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <big><big><strong>Cargos</strong></big></big>&nbsp;
                                            </div>
                                            <div class="col-lg-2 text-center">
                                                <ul class="nav nav-pills">
                                                    <li class="nav-item">
                                                        <a href="crud_cargos_ite.php" class="btn btn-outline-primary"
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table id="datatable" class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0">
                                                            <?php
                                                            $query="SELECT * FROM `cat_puestos_ite` WHERE '1'";
                                                                ...
                                                                <td class="text-center">
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <form action="crud_cargos_ite.php"
                                                                                method="POST">
                                                                                <?php echo '<input type="hidden" name="id_edit" value="'.$id_cargo.'">';?>
                                                                            ...
                                                                            <form action="?edo3=<?=$filas['id']?>"
                                                                                method="POST">
                                                                                <?php echo '<input type="hidden" name="eliminar" value="'.$id_cargo.'">';?>
