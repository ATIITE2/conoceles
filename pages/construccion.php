                                                ...
                                                <div class="d-grid gap-2 col-lg-6 mx-auto">
                                                    <div class="container-xxl container-p-y">
                                                        <div class="misc-wrapper">
                                                            <h2 class="mb-2 mx-2">Ups!</h2>
                                                            <p class="mb-4 mx-2">Lamentamos el inconveniente, aun nos encontramos en cosntrucción de este apartado.</p>
                                                            <div class="mt-4">
                                                                <img src="../assets/img/illustrations/girl-doing-yoga-light.png"
                                                                    alt="girl-doing-yoga-light" width="400"
                                                                    class="img-fluid" />
                                                            </div>
                                                        </div>
                                                    </div>
