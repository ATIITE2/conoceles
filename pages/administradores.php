...
if(isset($_REQUEST['guardar'])){
    ...
    VALUES ('".$usr_nme."','".$password_hash."','1','2',NOW());";
    mysqli_query($con, $query);
    $last_id = mysqli_insert_id($con);
    //echo $query;
    //echo $password;

    $query="INSERT INTO `c_administradores` (`id_user`,`nombre`,`a_pate`,`a_mate`,`id_area`,`id_puesto`) 
...
if(isset($_REQUEST['actualizar'])){
    ...
    $query="UPDATE `c_administradores` SET `nombre` = '".$nombres_req_e."',`a_pate` = '". $appp_e."',
                            ...
                            <div class="col-lg-10 mb-6 order-0">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <big><big><strong>Administradores</strong></big></big>&nbsp;
                                            </div>
                                            <div class="col-lg-2 text-center">
                                                <ul class="nav nav-pills">
                                                    <li class="nav-item">
                                                        <a href="crud_administrador.php" class="btn btn-outline-primary"
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table id="datatable" class="table">
                                                        ...
                                                        <tbody class="table-border-bottom-0">
                                                            <?php
                                                            $query="SELECT * FROM `c_administradores` WHERE `id_user` != '1'";
                                                            $resultados=mysqli_query($con, $query);
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <form action="crud_administrador.php"
                                                                                method="POST">
                                                                            ...
                                                                            <form action="password_edit_admin.php"
                                                                                method="POST">
