                            ...
                            <div class="col-lg-10">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="areas_ite.php" method="POST">
                                                <div class="row">
                                                    <?php 
                                                    $id_area = $_REQUEST['id_edit'];
                                                    ...
                                                    $nombre_cor = $filas_1['nom_cor'];
                                                    $nombre_com = $filas_1['nom_com'];

                                                    ?>
                                                    <div class="col-lg-8">
                                                        <label for="exampleFormControlInput1"
                                                            class="form-label">Nombre Completo</label>
                                                        <input type="text" class="form-control" id="nombrecom"
                                                            name="nombrecom"
                                                            value="<?php echo $nombre_com; ?>" />
                                                    </div>
                                                    <div class="col-lg-4">
                                                        <label for="exampleFormControlInput1"
                                                            class="form-label">Nombre Corto</label>
                                                        <input type="text" class="form-control" id="nombrecor"
                                                            name="nombrecor"
                                                            value="<?php echo $nombre_cor; ?>" />
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-10">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    <div class="card-header text-center">
                                        <big><big>Agregar Nueva Área</big></big>
                                        <hr style="border-top:1px dotted" />
                                    </div>
                                    <div class="card-body">
                                        <form action="areas_ite.php" method="POST">
                                            <div class="row">
                                                <div class="col-lg-8">
                                                    <label for="exampleFormControlInput1"
                                                        class="form-label">Nombre Completo</label>
                                                    <input type="text" class="form-control" id="nombrecom" name="nombrecom"
                                                        placeholder="Ej. Dirección de Organización Electoral, Capacitación y Educación Cívica" />
                                                </div>
                                                <div class="col-lg-4">
                                                    <label for="exampleFormControlInput1" class="form-label">Nombre Corto</label>
                                                    <input type="text" class="form-control" id="nombrecor" name="nombrecor"
                                                        placeholder="Ej. DOECyEC" />
                                                </div>
                                            </div>
                                            <br>
                                            <div class="row">
