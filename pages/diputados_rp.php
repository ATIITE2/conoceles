...
<?php 
    if(isset($_REQUEST['guardar'])){
        ...
        VALUES ('".$last_id."','5','".$id_user_session."',NOW());";
        mysqli_query($con, $query);
        //echo $query;

        $query="INSERT INTO `c_cand_dip_rp` (`id_user`,`nombre`,`a_pate`,`a_mate`,`sobrenombre`,`curp`,`sexo`,`distrito`,`f_nacimiento`,`l_nacimiento`,`t_residencia`,`pp`) 
    ...
    if(isset($_REQUEST['actualizar'])){
        ...
        $query="UPDATE `c_cand_dip_rp` SET `nombre` = '".$nombres_n."',`a_pate` = '". $appp_n."',
                            ...
                            <div class="col-lg-10 mb-6 order-0">
                                <div class="card h-100">
                                    <div class="card-header">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <big><big><strong>Diputaciones Representación Proporcional
                                                        </strong></big></big>&nbsp;
                                            </div>
                                            <div class="col-lg-2 text-center">
                                                <ul class="nav nav-pills">
                                                    <li class="nav-item">
                                                        <a href="crud_cand_dip_rp.php" class="btn btn-outline-primary"
                                                ...
                                                <div class="table-responsive text-nowrap">
                                                    <table id="example" class="display table">
                                                        ...
                                                        <tbody class="table-border-bottom-0">
                                                            <?php
                                                            if($rol_session=='1'){
                                                                $query="SELECT * FROM `c_candidatos` WHERE `id_tipo_cand` = '5'";
                                                            } else {
                                                                $query="SELECT * FROM `c_candidatos` WHERE `id_tipo_cand` = '5' && `id_administrador` =  ".$id_user_session."";
                                                            }
                                                            ...
                                                            while($filas=mysqli_fetch_array($resultados)){
                                                                ...
                                                                $query="SELECT * FROM `c_cand_dip_rp` WHERE `id_user` = ".$filas['id_user']."";
                                                                ...
                                                                <td>
                                                                    <div class="dropdown">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <form action="crud_cand_dip_rp.php"
                                                                                method="POST">
                                                                            ...
                                                                            <form action="password_edit_dip_rp.php"
                                                                                method="POST">
