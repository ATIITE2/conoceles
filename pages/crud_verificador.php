                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header text-center">
                                            <big><big>Editar Verificador</big></big>
                                            <hr style="border-top:1px dotted" />
                                        </div>
                                        <div class="card-body">
                                            <form action="verificadores.php" method="POST">
                                                <div class="row">
                                                    <?php 
                                                    $id_user_edit=$_REQUEST['id_user_edit'];
                                                    //echo $id_user_edit;
                                                    $query="SELECT * FROM `c_verificadores` WHERE `id_user` = ".$id_user_edit."";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-10">
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header text-center">
                                            <big><big>Agregar Nuevo Verificador</big></big>
                                            <hr style="border-top:1px dotted" />
                                        </div>
                                        <div class="card-body">
                                            <form action="verificadores.php" method="POST">
