...
<head>
    ...
    <title>Diputados - Conoceles</title>
                            ...
                            <div class="col-lg-10">
                                <div class="col-md-12">
                                    <div class="card mb-4">
                                        ...
                                        <div class="card-body">
                                            <form action="diputados_mr.php" method="POST">
                                                <div class="row">
                                                    <?php 
                                                    $id_user_new_pass=$_REQUEST['id_user_new_pass'];
                                                    $query="SELECT * FROM `c_cand_dip_mr` WHERE `id_user` = ".$id_user_new_pass."";
                                        ...
                                        <div class="card-footer">
                                            ...
                                            <a href="diputados_mr.php" class="menu-link"><button
